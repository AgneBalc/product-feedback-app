...
const buttonVariants = cva(
  "border-none inline-flex items-center transition ease-in-out duration-300 focus:outline-none rounded-md",
  {
    variants: {
      variant: {
      ...
      size: {
        ...
        fixed:
          "w-[69px] h-8 pl-4 sm:pl-0 sm:h-[53px] sm:w-10 sm:pb-2 sm:pt-[14px]",
      },
    },
  }
);
